...
TacticalAgent pairs (n=24, content-derived seeds); REACH-v3 (threshold
family only) FIRES on draw-heavy genomes — >= 5/24 of the genome's own T1
games end winner-None, the S2-style draw pathology (§4 [C8]; CAL-R: S2
fires 10/24, e1453 silent 1/24). Fired guard = veto, exactly like
RUSH/TILT (BUILD_LOG errata #11)."""
...
N_PAIRS = 12
REACH_FIRE_COUNT = 5      # >= 5/24 winner-None VETOES a threshold genome —
                          # S2-style draw pathology; CAL-R validated
