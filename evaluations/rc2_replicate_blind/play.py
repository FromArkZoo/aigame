...
Loads anonymized game definitions from evaluations/rc2_replicate_blind/games/<LABEL>.json
...
Usage:
    ...
    .venv/bin/python evaluations/rc2_replicate_blind/play.py --game A --moves "12,40,7" [--values] [--legal]
