...
- EVERYTHING under `evaluations/` EXCEPT this pack directory
  (`evaluations/rc2_replicate_blind/`): no other evaluation pack, no prior verdicts,
  no summaries.
...
## How to run a game
    ...
    .venv/bin/python evaluations/rc2_replicate_blind/play.py --game A --rules
    .venv/bin/python evaluations/rc2_replicate_blind/play.py --game A --legal
    .venv/bin/python evaluations/rc2_replicate_blind/play.py --game A --moves "<csv action ids>" [--legal] [--values]
...
- **Team 1:** F, G, C, B, E, D, A
- **Team 2:** D, F, G, C, E, B, A
- **Team 3:** A, D, C, E, B, F, G
...
Write each verdict to:
    ...
    evaluations/rc2_replicate_blind/team-{N}_game{A..G}.md
...
to `evaluations/rc2_replicate_blind/`. BEFORE opening the mapping, run the pre-unblind
identifier grep over the filed verdicts:

    .venv/bin/python experiments/rc2_campaign/grep_verdicts.py evaluations/rc2_replicate_blind
