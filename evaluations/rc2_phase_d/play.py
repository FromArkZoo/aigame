...
Loads anonymized game definitions from evaluations/rc2_phase_d/games/<LABEL>.json
...
Usage:
    ...
    .venv/bin/python evaluations/rc2_phase_d/play.py --game A --moves "12,40,7" [--values] [--legal]
