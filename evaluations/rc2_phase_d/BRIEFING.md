# RC2 Phase D blind eval — agent team briefing
...
Do NOT read: `.blind_mapping.json`, `PREREGISTRATION.md` (in this directory),
...
## How to run a game
    ...
    .venv/bin/python evaluations/rc2_phase_d/play.py --game A --rules
    .venv/bin/python evaluations/rc2_phase_d/play.py --game A --legal
    .venv/bin/python evaluations/rc2_phase_d/play.py --game A --moves "<csv action ids>" [--legal] [--values]
...
- **Team 1:** C, B, F, G, E, D, A
- **Team 2:** F, B, A, E, G, D, C
- **Team 3:** F, C, G, A, B, D, E
...
Write each verdict to:
    ...
    evaluations/rc2_phase_d/team-{N}_game{A..G}.md
...
to `evaluations/rc2_phase_d/`. Open `.blind_mapping.json` at that point, and
apply the validity band, BAR D1/D2, and the locked decision grammar exactly
as written in `PREREGISTRATION.md` (same directory).
